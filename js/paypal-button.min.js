    ...
    function (a) {
        ...
        function c(b, c) {
            var e, f, g, h, k, l, m, o, p, q, r, s, t, u, v, w = a.createElement("form"),
                ...
                F = [],
                G = {};
            w.method = "post", w.action = j.replace("{env}", b.items.env.value), w.className = "paypal-button", w.target = "_blank";
        ...
        var i = {},
            j = "https://{env}.paypal.com/cgi-bin/webscr",
            k = "https://{env}.paypal.com/webapps/ppint/qrcode?data={url}&pattern={pattern}&height={size}",
        ...
        if (PAYPAL.apps.ButtonFactory || (i.config = {
            ...
            var o, p, q, r, s, t, u = PAYPAL.apps.ButtonFactory,
